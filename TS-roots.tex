...
We use \Cref{eqn622} to approximate the covariance matrix of two datasets $\mathcal{X}$ and $\mathcal{X}'$ that consist of $N_\text{p}$ samples of $x \in [-1,1]$ and $N_\text{p}$ samples of $x' \in [-1,1]$.
...
\Cref{fig:approxError} shows the error for different values of $N$ and $l$.

\begin{figure}[t]
	\centering
	\includegraphics[width=0.7\linewidth]{img/approxError.pdf}
